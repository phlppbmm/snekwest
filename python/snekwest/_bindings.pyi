...
class PreparedRequest:
    ...
    def prepare_body(self, data: Any = None, files: Any = None, json: Any = None) -> None: ...
...
class Response:
    ...
    def iter_lines(self, chunk_size: int = 512, decode_unicode: bool = False, delimiter: Optional[str] = None) -> Iterator[bytes]: ...
    def close(self) -> None: ...
